    ...
    <>
      <div className="flex flex-row p-4 gap-2">
        <div className="bg-blue-100 dark:bg-black/40  w-full rounded-2xl p-10 items-center justify-center content-center">
          <h1 className="text-5xl font-semibold">Turnos</h1>
          <p className="text-xl">Aqui puedes crear turnos para tus pacientes</p>
      ...
      <CrearTurno actualizarLista={actualizarLista} />
      <ListarTurnos reload={reload} />
    </>
  );
}
